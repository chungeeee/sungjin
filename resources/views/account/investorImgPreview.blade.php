...
<div class="pt-0 p-2 ">
	<div class="" style="text-align:center;height:820px;">
		@if($ext == 'pdf')
		    <iframe src='/pdfjs/web/viewer.html?file=/account/getinvestorinfoimg/{{$no}}/{{$loan_usr_info_no}}#page=30' style='width:100%;height:inherit'></iframe>
		@elseif($ext == 'tif' || $ext == 'tiff')
            ...
            <script>tiff_view("/account/getinvestorinfoimg?no={{$no}}&loan_usr_info_no={{$loan_usr_info_no}}", "0");</script>
		@else
            <img style="width:100%;" src='/account/getinvestorinfoimg/{{$no}}/{{$loan_usr_info_no}}'>
		@endif
	</div>
</div>
