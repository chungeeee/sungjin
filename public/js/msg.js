...
'korean':{
	...
	"PdfDownloadChromeMsg" : "PDF 파일에 암호가 설정되어 파일이 <b>다운로드</b>됩니다.<br>인쇄를 원하는 경우 <b>저장 버튼</b>을 이용하여 파일 저장 후 인쇄할 수 있습니다.",
...
'english':{
	...
	"PdfDownloadChromeMsg" : "The <b>PDF file will be downloaded</b> because the password is set in the file.<br>If you want to print, save the file using the <b>Save button</b>, and then print.",
