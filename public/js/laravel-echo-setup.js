...
var isLocal = window.location.hostname.indexOf('loc-');
if(isLocal>=0)
{
  socket_host = 'http://' + socket_host.replace('loc-', 'dev-');
}

window.Echo = new laravel_echo__WEBPACK_IMPORTED_MODULE_0__["default"]({
  broadcaster: 'socket.io',
  host: socket_host + ":" + window.laravel_echo_port
...
module.exports = __webpack_require__("./resources/js/laravel-echo-setup.js");
