...
<form class="form-horizontal" role="form" name="mo_in_money_form" id="mo_in_money_form" method="post">
...
<div class="form-group row">
    <label for="type" class="col-sm-2 col-form-label"><font class='pl-1 pr-1' color='red'>*</font>입금구분</label>
    <div class="col-sm-4">
        <select class="form-control form-control-sm col-sm-7" id="type" name="type">
            <option value=''>입금구분</option>
            <option value='0'>일반입금</option>
            <option value='1'>기타입금</option>
        </select>
    </div>
    <label for="save_date" class="col-sm-2 col-form-label"><font class='pl-1 pr-1' color='red'>*</font>입금일</label>
    <div class="col-sm-4">
        <div class="input-group date" id="div_save_date" data-target-input="nearest">
            <input type="text" class="form-control form-control-sm datetimepicker-input dateformat col-sm-5" id="save_date" name="save_date" placeholder="입금일" data-target="#div_save_date" value="{{ $v->save_date ?? '' }}"/>
...
<div class="form-group row">
    ...
    <label for="in_money" class="col-sm-2 col-form-label"><font class='pl-1 pr-1' color='red'>*</font>입금액</label>
    <div class="col-sm-4">
        <input type="text" class="form-control form-control-sm moneyformat" id="in_money" name="in_money" placeholder="원단위 입력">
    </div>
</div>
</form>
