...
<form class="form-horizontal" name="search_form" id="search_form" onSubmit="searchCust(); return false;">

<div class="card card-lightblue">

    <div class="card-header-no-round">
    <h2 class="card-title">투자자 검사</h2>
    </div>
    ...
    <div class="card-body pr-1 pl-1">
        ...
        <div class="input-group row">
            ...
            <div class="col-sm-6 p-0">
                ...
                <input type="text" class="form-control form-control-sm col-sm-12" id="search_string" placeholder="투자자번호, 성명, 핸드폰, 기타전화, 번호뒤4자리, 주민번호" value="{{ $searchStr }}" />
...
function searchCust(loanAppNo)
{
    ...
    $.post("/{{ $requestUri }}/searchaction", {searchStr:search_string, loanAppNo:loanAppNo, order_colm:oc, order_type:ot}, function(data) {
