...
var TempusDominusBootstrap4 = function ($) {
  ...
  var TempusDominusBootstrap4 = /*#__PURE__*/function (_DateTimePicker) {
    ...
    _proto2._fillDate = function _fillDate() {
      ...
      var date_ymd = moment(this._viewDate._d).format('YYYY-MM-DD');
      var today    = date_ymd.split('-');
      var y        = today[0];
      var m        = today[1];
      ...
      for (i = 0; i < 42; i++)
      {
        ...
        row.append("<td data-action=\"selectDay\" data-day=\"" + currentDate.format('YYYY-MM-DD') + "\" class=\"text-sm day" + clsName + "\" >" + currentDate.date() + " </td>");
        currentDate.add(1, 'd');
      ...
      $.ajax({
        ...
        data  : { y:y, m:m },
          success : function(result)
          {
            ...
            {
              $(".datepicker-days").find(".day[data-day='"+result[key]['day']+"']").addClass('weekend');
            }
          },
          error : function(xhr)
          {
