    ...
    <div class="col-md-12">
        <div class="card card-outline card-lightblue">        
            <div class="card-header p-1">
                <h3 class="card-title"><i class="fas fa-user m-2" size="9px">자재단가표 엑셀업로드</i>
            </div>
...
<script>
    ...
    function saveExcel()
    {
        ...
        $.ajax({
            url:"/field/managementmaterialexcelaction",
            type:"POST",
            data:formData,
            processData:false,
            contentType:false,
    ...
    function downSample()
    {
        location.href='/field/managementmaterialexcelsample';
    }
