...
(function (global, factory) {
  ...
  var CLASS_NAME_ICON_SEARCH = 'fa-arrow-right';
  ...
  var SidebarSearch = /*#__PURE__*/function () {
    ...
    _proto._parseItem = function _parseItem(item, path) {
      ...
      var mncd = navLink.attr('mncd');

      itemObject.name = ( typeof mncd!="undefined" ) ? "("+mncd+") "+this._trimText(name) : this._trimText(name) ;
  ...
  var Toasts = /*#__PURE__*/function () {
    ...
    _proto.create = function create() {
      ...
      if (this._config.body != null) {
        ...
        // 링크설정 추가
        var popurl = "";
        if( this._config.msgno !=null ) {
          var popurl = 'onclick="popupMsg(' + this._config.msgno + ');" data-dismiss="toast"';
        }

        toast.append($__default['default']('<div class="toast-body" '+popurl+' />').html(this._config.body));
      }
