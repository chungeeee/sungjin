...
<b>변경내역</b>
<select class="form-control form-control-sm  col-md-1 float-right mb-1" name="searchSelect" id="searchSelect" onchange="getCustData('change',this.value);">
{{ Func::printOption($array_select,$selected) }}
</select>
<table class="table table-sm table-hover loan-info-table card-secondary card-outline text-sm">
